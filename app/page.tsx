...
export default function Home() {
  ...
  // Show loading or fallback until mounted and user data is loaded
        ...
        <main className="w-full">
          <div className="h-[50rem] flex items-center justify-center relative overflow-hidden">
            ...
            <div className="z-10 flex flex-col items-center text-center space-y-6">
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-4 opacity-50">
                <Button className="w-40 h-10 rounded-xl bg-black border dark:border-white border-transparent text-white text-sm" disabled>
                  Loading...
                </Button>
                <Button className="w-40 h-10 rounded-xl bg-white text-black border border-black text-sm" disabled>
                  Loading...
                </Button>
              </div>
            </div>
